...
<body>
    ...
    <section class="banner__container">
        ...
        <div class="banner__image">
            <img src="assets/konstruksi_atap1.gif" alt="banner">
        </div>
    </section>
    ...
    <section class="service" id="service">
        <div class="section_container service__container">
            <p class="section__subheader">MENGAPA MEMILIH KAMI</p>
            <h2 class="section__header">Great Machine Service</h2>
            <p class="section__description">
                Trust us to keep your industries machine running smothly and reliably.
            </p>
            <div class="service__grid">
                <div class="service__card">
                    <img src="assets/pagar3.jpg" alt="service">
                    <h4>
                        Pagar
                    </h4>
                    <p>
                        Experience smoother rides and extended tire life with our
                        alignment service.
                    </p>
                </div>
                <div class="service__card">
                    <img src="assets/tangga1.jpg" alt="service">
                    <h4>
                        Tangga
                    </h4>
                    <p>
                ...
                <div class="service__card">
                    <img src="assets/auto_gate1.jpg" alt="service">
                    <h4>
                        Gerbang Otomatis
                    </h4>
                    <p>
                ...
                <div class="service__card">
                    <img src="assets/rak.png" alt="service">
                    <h4>
                        Kitchen Set
                    </h4>
                    <p>
    ...
    <section class="section__container price__container" id="price">
        <p class="section__subheader">BEST PACKAGE</p>
        <h2 class="section__header">Our Pricing Plant</h2>
        <p class="section__description">
            We offer a range of affordable pricing option.
        </p>
        <div class="price__grid">
            <div class="price__card">
                <h4>SILVER PACKAGE</h4>
                <h3><sup>Rp</sup>250.000</h3>
                <p>tebal besi 0,8mm</p>
                <p>besi galvanis</p>
                <p>cat 1 lapis</p>
                <p></p>
                <p></p>
                <p></p>
                <button class="btn">cek lebih lanjut</button>
            </div>
            <div class="price__card">
                <div class="price__card__ribbon">BESTSELLER</div>
                <h4>PLATINUM PACKAGE</h4>
                <h3><sup>Rp</sup>600.000</h3>
                <p>tebal besi 1,5mm</p>
                <p>besi galvanis</p>
                <p>cat 2 lapis</p>
                <p></p>
                <p></p>
            ...
            <div class="price__card">
                <h4>GOLD PACKAGE</h4>
                <h3><sup>Rp</sup>350.000</h3>
                <p>tebal besi 1,0mm</p>
                <p>besi galvanis</p>
                <p>cat 2 lapis</p>
                <p></p>
                <p></p>
